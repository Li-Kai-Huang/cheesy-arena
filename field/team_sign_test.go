...
func TestTeamSign_GenerateInMatchRearText(t *testing.T) {
	...
	// R095-B130 25
	assert.Equal(t, "01:23 R105-B220\n 25", generateInMatchTeamRearText(arena, true, "01:23"))

	// 測試藍隊視角: "倒數時間 B分數-R分數 B球數"
	// B130-R095 50
	assert.Equal(t, "01:23 B220-R105\n 50", generateInMatchTeamRearText(arena, false, "01:23"))
}
